...
public class KafkaTest {
    ...
    static class KafkaTestContainersConfiguration {
        ...
        public Map<String, Object> consumerConfigs() {
            ...
            props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "PLAINTEXT://localhost:49156");
        ...
        public ProducerFactory<String, Contract> producerFactory() {
            ...
            configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "PLAINTEXT://localhost:49156");
